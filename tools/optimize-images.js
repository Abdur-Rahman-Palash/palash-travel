 ...
 * NOTE: sharp must be installed as a devDependency before running this script:
 *   npm install --save-dev sharp
 * Then run:
 *   npm run optimize:images
 *
 * The script will create webp versions and resized variants (480, 768, 1200px widths)
 */
const fs = require('fs');
...
const outDir = (p) => p; // overwrite in place (keep same folder)
...
async function processFile(filePath) {
  ...
  // resized jpeg/png -> keep original format
